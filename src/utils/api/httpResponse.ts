import { HTTPSTATUS } from "../enums/httpResponse";
 ...
 export class HttpResponse {
    ...
    public readonly data: Record<string, unknown> | unknown[] | string | undefined;
    public readonly others: Record<string, unknown> | unknown[] | undefined;
    public readonly stack: Record<string, unknown> | string | unknown;
    public readonly pagination: Record<string, unknown> | unknown[] | string | undefined;
    constructor({ statusCode, message, data, docs, others, stack, pagination }: HttpResponseProps) {
